 ...
 *                       Kenneth brill
 *                       2006-05-05 ken.brill@gmail.com
 *
 * The Initial Developer of the Original Code is SugarCubed / Kenneth Brill
 * Portions created by Kenneth Brill are Copyright (C) 2006 Kenneth Brill
 * All Rights Reserved.
 ********************************************************************************/
...
global $current_user;
/*
	if(!empty($focus->billing_address_street)) {
//		$module_menu[] =Array("http://maps.msn.com/home.aspx?strt1=$focus->billing_address_street&city1=$focus->billing_address_city&stnm1=$focus->billing_address_state&zipc1=$focus->billing_address_postalcode&cnty1=0", $mod_strings['LBL_MAP'],"Import", 'Contacts');
		$module_menu[] =Array("http://maps.google.com/maps?oi=map&q=$focus->billing_address_street+$focus->billing_address_city+$focus->billing_address_state+$focus->billing_address_postalcode", $mod_strings['LBL_MAP'],"Map", 'Contacts');
		if(!empty($current_user->address_street)) {
				$module_menu[] =Array("http://maps.google.com/maps?saddr=$focus->billing_address_street+$focus->billing_address_city+$focus->billing_address_state+$focus->billing_address_postalcode&daddr=$current_user->address_street+$current_user->address_city+$current_user->address_state+$current_user->address_postalcode", $mod_strings['LBL_DIRECTIONS'], "Directions", 'Contacts');
		}
	}
