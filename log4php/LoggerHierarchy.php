...
/* --------------------------------------------------------------------------*/
    ...
    {
    	// lock down the logger to be a static variable.
    	static $sugar_global_logger;

    	if(!$sugar_global_logger)
    	{
    		$sugar_global_logger = $this->getLoggerByFactory($name, $this->defaultFactory);
    	}
    	
    	return $sugar_global_logger;
    } 
