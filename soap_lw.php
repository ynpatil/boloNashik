...
//$server->configureWSDL('sugarsoap', $NAMESPACE, 'http://10.100.109.191/fq/soap.php?wsdl');
$server->configureWSDL('sugarsoap', $NAMESPACE, 'http://respforce.timesgroup.com/fq/soap.php?wsdl');
