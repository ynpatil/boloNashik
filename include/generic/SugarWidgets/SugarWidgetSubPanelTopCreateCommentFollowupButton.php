...
class SugarWidgetSubPanelTopCreateCommentFollowupButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		//echo "Return module :".$defines['focus']->module_dir;
		$button .= '<input type="hidden" name="to_pdf" value="true" />';
        $button .= '<input type="hidden" name="tpl" value="QuickCreateFollowup.tpl" />';
		$button .= '<input type="hidden" name="return_module" value="' . $defines['focus']->module_dir . "\" />\n";
		...
		if(empty($additionalFormFields['parent_type']))
		{
			if($defines['focus']->object_name=='Contact') {
				...
				$additionalFormFields['parent_assigned_user_id'] = $defines['focus']->assigned_user_id;				
			}
		}
		...
		$button .= '<input type="hidden" name="action" value="SubpanelCreatesFollowup" />' . "\n";
		$button .= '<input type="hidden" name="module" value="Comments" />' . "\n";
