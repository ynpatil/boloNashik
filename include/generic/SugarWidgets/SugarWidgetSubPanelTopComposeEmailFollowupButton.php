...
class SugarWidgetSubPanelTopComposeEmailFollowupButton extends SugarWidgetSubPanelTopButton
{
	function display($defines)
	{
		...
		//override for followup activities
		$additionalFormFields['parent_type'] = '';//$defines['focus']->module_dir;
		$additionalFormFields['parent_id'] = '';//$defines['focus']->id;
		$additionalFormFields['parent_name'] = '';//$defines['focus']->name;

		$additionalFormFields['isassoc_activity'] = true;
		$additionalFormFields['followup_for_id'] = $defines['focus']->id;
		...
		$button .= "</form>";
//		$GLOBALS['log']->debug("Buttons text :".$button);
		return $button;
	}
    ...
    function &_get_form($defines, $additionalFormFields = null)
    {
		...
		//for follow up activities not required.
/*
