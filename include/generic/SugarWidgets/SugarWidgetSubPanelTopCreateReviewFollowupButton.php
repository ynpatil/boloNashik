...
class SugarWidgetSubPanelTopCreateReviewFollowupButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$button .= '<input type="hidden" name="module" value="Reviews" />' . "\n";
