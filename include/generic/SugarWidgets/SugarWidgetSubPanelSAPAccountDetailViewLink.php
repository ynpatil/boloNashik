...
class SugarWidgetSubPanelSAPAccountDetailViewLink extends SugarWidgetField
{
	...
	{			
		...
		if(  
			...
			. '&return_module=' . $layout_def['return_module']
			. '&return_action=' .$layout_def['return_action']
