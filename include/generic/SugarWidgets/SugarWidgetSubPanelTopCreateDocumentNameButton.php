...
class SugarWidgetSubPanelTopCreateDocumentNameButton extends SugarWidget
{
    var $module;
	var $title;
	var $access_key;
...
//TODO rename defines to layout defs and make it a member variable instead of passing it multiple layers with extra copying.
	...
	*/
	function SugarWidgetSubPanelTopCreateDocumentNameButton($module='', $title='', $access_key='', $form_value='')
	{
		global $app_strings;
