...
Modified by J.Benterou: changed lines 2049 to 2051
Fixed adjacent element bug in YAHOO.util.DDM.swapNode.
See line 2034 for details.
*/ 
...
if (!YAHOO.util.DragDropMgr) {
    ...
    YAHOO.util.DragDropMgr = new function() {
         ...
         *
         * Modified by J.Benterou: fixed behavior when n2.nextSibling == n1.
         * Without this fix, an exception is thrown on 'p.insertBefore(n1,s)'
         *  because s == n1, which has been removed from the DOM by the call
         *  to replaceChild(n2, n1). So in that situation, just insert n1 
         *  before n2.
         *
