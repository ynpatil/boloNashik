...
function get_popup_account_data()
{
	return window.document.popup_account_data;
}
...
function open_popup_for_member_accounts(module_name, width, height, initial_filter, close_popup, hide_clear_button, popup_request_data, popup_mode, create, metadata,popup_account_data)
{
	//alert("In open_popup");
	// set the variables that the popup will pull from
	window.document.popup_request_data = popup_request_data;
	window.document.popup_account_data = popup_account_data;
	window.document.close_popup = close_popup;

	// launch the popup
	URL = 'index.php?'
		+ 'module=' + module_name
		+ '&action=Popup_MemberAccount';
...
function open_popup1(module_name, width, height, initial_filter, close_popup, hide_clear_button, popup_request_data, popup_mode, create, metadata)
{
	//alert("In open_popup");
	// set the variables that the popup will pull from
	window.document.popup_request_data = popup_request_data;
...
//			alert("Popup :"+the_key+" = "+displayValue);
		}
	}
}
