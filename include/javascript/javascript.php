 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: javascript.php,v 1.44 2006/08/22 05:18:57 wayne Exp $
...
class javascript{
	...
	function addField($field,$required, $prefix='', $displayField=''){
		if(isset($this->sugarbean->field_name_map[$field]['vname'])){
			...
			if(isset($this->sugarbean->field_name_map[$field]['validation'])){
				...
				$this->addFieldGeneric($dispField,$this->sugarbean->field_name_map[$field]['type'],$this->sugarbean->field_name_map[$field]['vname'],$required,$prefix );
			}
		}else{
	...
	function addAllFields($prefix,$skip_fields=null){
		...
		//echo "Fields :".implode(",",$this->sugarbean->file_name_map);
