...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAkug0nthHAqR_qYi5pwmw_BQYsLKN5NqFsfbmiZH2gKY1ORFcyBSWv8CFEh8VNQyYaAh-MqLyIAZ6jg" type="text/javascript"></script>
  </head>
			...
			<tr>
				...
				<td>
					<table>
						...
						<form name="form_map" action="/sfa/google/map.php" method="POST">
...
if(!empty($_REQUEST['location'])) {
	$a = yahoo_geo($title = $_REQUEST['location']);
...
?>						<tr><td>Lat:</td><td><input type="text" id="lat" value="<?php echo $lat; ?>" /></td></tr>
						<tr><td>Lng:</td><td><input type="text" id="lng" value="<?php echo $lng; ?>" /></td></tr>
						<tr><td>Title:</td><td><input type="text" id="title" size="40" value="<?php echo $title; ?>" /></td></tr>
