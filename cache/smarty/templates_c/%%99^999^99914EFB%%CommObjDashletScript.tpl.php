<?php /* Smarty version 2.6.11, created on 2012-04-09 02:47:57
         compiled from modules/AccountObjective/Dashlets/CommObjDashlet/CommObjDashletScript.tpl */ ?>
	...
	JotPad = function() {
	    return {
	        ...
	        blur: function(ta, id) {
    	    	...
    	    	postData = \'to_pdf=1&module=AccountObjective&action=CallMethodDashlet&method=saveText&record=';  echo $this->_tpl_vars['record'];  echo '&id=\' + id + \'&savedText=\' + ta.value;
...
//alert("OM "+postData);
			...
			edit: function(divObj, id) {
		        	...
		        	//alert("Owner ';  echo $this->_tpl_vars['owner'];  echo '");
				...
				//alert("Getting id :"+\'jotpad_textarea_';  echo $this->_tpl_vars['column'];  echo '_\' + id);
