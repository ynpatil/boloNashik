<?php /* Smarty version 2.6.11, created on 2012-04-09 02:47:50
         compiled from modules/AccountMktInfo/Dashlets/AnnualBusinessInfoDashlet/AnnualBusinessInfoDashletScript.tpl */ ?>
	    ...
	    return {
	        ...
	        blur: function(ta, id) {
	        	...
	        	// what data to post to the dashlet
    	    		...
    	    		postData = \'to_pdf=1&module=AccountMktInfo&action=CallMethodDashlet&method=saveText&record=';  echo $this->_tpl_vars['record'];  echo '&return_module=';  echo $this->_tpl_vars['parent_type'];  echo '&id=\' + id + \'&savedText=\' + ta.value;
    	    	
		    	//alert("In blur "+postData);
