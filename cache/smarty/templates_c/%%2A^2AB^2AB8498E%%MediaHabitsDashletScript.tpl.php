<?php /* Smarty version 2.6.11, created on 2012-05-31 15:33:38
         compiled from modules/AccountTG/Dashlets/MediaHabitsDashlet/MediaHabitsDashletScript.tpl */ ?>
	...
	JotPad = function() {
	    return {
	        ...
	        blur: function(ta, id) {
    	    	...
    	    	postData = \'to_pdf=1&module=AccountTG&action=CallMethodDashlet&method=saveText&record=';  echo $this->_tpl_vars['record'];  echo '&id=\' + id + \'&savedText=\' + ta.value;
