<?php /* Smarty version 2.6.11, created on 2012-04-13 19:08:48
         compiled from modules/Meetings/tpls/QuickCreateFollowup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'modules/Meetings/tpls/QuickCreateFollowup.tpl', 54, false),)), $this); ?>
...
" class="button" type="submit" name="button" <?php echo ((is_array($_tmp=@$this->_tpl_vars['saveOnclick'])) ? $this->_run_mod_handler('default', true, $_tmp, "onclick=\"return check_form('meetingsQuickCreate');\"") : smarty_modifier_default($_tmp, "onclick=\"return check_form('meetingsQuickCreate');\"")); ?>
...
" class="button" type="submit" name="button" onclick="this.form.to_pdf.value='0';this.form.action.value='EditView'; this.form.module.value='Meetings';" value="  <?php echo $this->_tpl_vars['APP']['LBL_FULL_FORM_BUTTON_LABEL']; ?>
  "></td>
...
<?php echo '
Calendar.setup ({
	inputField : "jscal_field", ifFormat : "';  echo $this->_tpl_vars['CALENDAR_DATEFORMAT'];  echo '", onClose: function(cal) { 
cal.hide(); }, showsTime : false, button : "jscal_trigger", singleClick : true, 
step : 1
});
'; ?>
