<?php /* Smarty version 2.6.11, created on 2012-05-31 15:33:38
         compiled from modules/AccountTG/Dashlets/PsychographicDashlet/PsychographicDashletScript.tpl */ ?>
	    ...
	    return {
	        ...
	        blur: function(ta, id) {
	        	...
	        	// what data to post to the dashlet
    	    		...
    	    		postData = \'to_pdf=1&module=AccountTG&action=CallMethodDashlet&method=saveText&record=';  echo $this->_tpl_vars['record'];  echo '&return_module=';  echo $this->_tpl_vars['parent_type'];  echo '&id=\' + id + \'&savedText=\' + ta.value;
