 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Chart_pipeline_by_lead_source.php,v 1.14 2006/08/30 02:26:23 wayne Exp $
	...
	*/
	function gen_xml($legends=array('foo','bar'), $user_id=array('1'), $cache_file_name='a_file', $refresh=true,$current_module_strings) {
		...
		if (!file_exists($cache_file_name) || $refresh == true) {
			...
			$total = round($total, 2);
			$title = $current_module_strings['LBL_TOTAL_PIPELINE'].format_number($total, 2, 2);
