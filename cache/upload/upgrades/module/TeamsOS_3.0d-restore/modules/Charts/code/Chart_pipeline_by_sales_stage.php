 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Chart_pipeline_by_sales_stage.php,v 1.15 2006/08/30 02:26:37 wayne Exp $
...
//				}
			...
			foreach ($datax as $key=>$translation) {
				...
				if(isset($stageArr[$key]['row_total'])){$fileContents .= format_number($stageArr[$key]['row_total'], 2, 2);}
				$fileContents .= '">'."\n";
