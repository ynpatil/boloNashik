 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Chart_lead_source_by_outcome.php,v 1.11 2006/08/30 02:25:35 wayne Exp $
	...
	*/
	function  gen_xml($datay=array('foo','bar'), $user_id=array('1'), $cache_file_name='a_file', $refresh=false,$current_module_strings) {
		...
		if (!file_exists($cache_file_name) || $refresh == true) {
			...
			$total = round($total, 2);
			$title = '<graphData title="'.$current_module_strings['LBL_ALL_OPPORTUNITIES'].format_number($total, 2, 2).'">'."\n";
