...
if(isset($_REQUEST['query'])){
 ...
 if(isset($class)             && $class  != "")            array_push($where_clauses, "problem.class           = '".PearDatabase::quote($class) ."'");
  ...
  $theseKeywords = "";
 	if(isset($keyword1)         && $keyword1 != "") array_push($where_clauses, "MATCH (problem.name,problem.description) AGAINST ('".$keyword1."' IN BOOLEAN MODE)");
 	if(isset($keyword2)         && $keyword2 != "") array_push($where_clauses, "MATCH (problem.name,problem.description) AGAINST ('".$keyword2."' IN BOOLEAN MODE)");
 	if(isset($keyword3)         && $keyword3 != "") array_push($where_clauses, "MATCH (problem.name,problem.description) AGAINST ('".$keyword3."' IN BOOLEAN MODE)");
 	if(isset($keyword4)         && $keyword4 != "") array_push($where_clauses, "MATCH (problem.name,problem.description) AGAINST ('".$keyword4."' IN BOOLEAN MODE)");
 }
