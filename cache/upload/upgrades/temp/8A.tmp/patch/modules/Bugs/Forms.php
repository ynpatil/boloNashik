...
//$the_form = substr($form,0,strlen($form)-strlen(strrchr($form,"</p>"))); //remove the trailing </p>
...
$the_form .= "</select></p><p>";
$the_form .= "<input title='${lbl_save_button_title}' accessKey='${lbl_save_button_key}' class='button' type='submit' name='button' value='  ${lbl_save_button_label}  ' ></p></form>";
/* end Lampada change */
