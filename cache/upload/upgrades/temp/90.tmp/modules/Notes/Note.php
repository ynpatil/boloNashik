 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Note.php,v 1.81.4.3 2006/01/17 22:49:56 wayne Exp $
 * Description:  Changes for KnowledgeBase module:
 * Description:  Changed routines: fill_in_additional_parent_fields.
 *               logic to add parent field to ProbemSolution object.
 * Portions created by SugarCRM are Copyright (C) SugarCRM, Inc.
 * All Rights Reserved.
 * Contributor(s): Olavo Farias.
 ********************************************************************************/
...
// START KnowledgeBase - by Olavo
		elseif ($this->parent_type == "ProblemSolution") {
...
// END   KnowledgeBase - by Olavo
     ...
     elseif ($this->parent_type == "Meetings" || $this->parent_type == "Calls") {
    	global  $beanList, $beanFiles; 
			$class_name = $beanList[$this->parent_type];
