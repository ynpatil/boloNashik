...
function additionalDetailsRelationshipType($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'RelationshipTypeMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=RelationshipTypeMaster&return_module=RelationshipTypeMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=RelationshipTypeMaster&return_module=RelationshipTypeMaster&record={$fields['ID']}");
}
