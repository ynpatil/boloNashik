...
/**
 * The detailed view for a LinkageMaster
 *
...
$GLOBALS['log']->info('LinkageMaster detail view');
$focus = new Linkage();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("LINKAGE", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/LinkageMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "LINKAGE", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'LINKAGE');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('LinkageMaster')));
$str = "<script>
