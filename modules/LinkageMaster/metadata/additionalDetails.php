...
function additionalDetailsLinkage($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'LinkageMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=LinkageMaster&return_module=LinkageMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=LinkageMaster&return_module=LinkageMaster&record={$fields['ID']}");
}
