...
require_once("modules/Tasks/TaskRequestListViewQuery.php");
require_once("modules/Tasks/TaskRequestListViewDisplay.php");

if(count($account_list)>0)
{
echo "\n<p>\n";

$xtpl=new XTemplate ('modules/Tasks/SubPanelTaskRequestView.html');
$current_module_strings = return_module_language($current_language, 'Tasks');
...
foreach($account_list as $account)
{
 ...
 $xtpl->assign("TASK", $activity_fields);
