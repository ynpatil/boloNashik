...
function get_new_record_form()
{
	return '';
/*
	if(!ACLController::checkAccess('BranchMaster', 'edit', true))return '';
	global $app_strings;
	global $mod_strings;
	global $currentModule;
	global $current_user;

	$the_form = get_left_form_header($mod_strings['LBL_QUICK_NEW_BRANCH']);
	$form = new XTemplate ('modules/BranchMaster/Forms.html');
	...
	$form->assign('encoded_branch_popup_request_data', $json->encode($popup_request_data));
