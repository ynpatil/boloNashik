...
function additionalDetailsBranch($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'BranchMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=BranchMaster&return_module=BranchMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=BranchMaster&return_module=BranchMaster&record={$fields['ID']}");
}
