...
$GLOBALS['log']->info('Branch detail view');
$focus = new Branch();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("BRANCH", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/BranchMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "BRANCH", $offset, $focus->is_AuditEnabled());
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('BranchMaster')));
$str = "<script>
