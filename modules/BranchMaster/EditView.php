...
require_once('modules/BranchMaster/Forms.php');
...
$GLOBALS['log']->info("Branch Master detail view");

$xtpl=new XTemplate ('modules/BranchMaster/EditView.html');
...
if($focus->feedback_option== '1'){
    $xtpl->assign("FEEDBACK_OPTION", "checked");
}
//Add Custom Fields
