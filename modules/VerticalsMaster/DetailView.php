...
/**
 * The detailed view for a Verticals
 *
...
$GLOBALS['log']->info('Verticals detail view');
$focus = new Verticals();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("VERTICALS", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/VerticalsMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "VERTICALS", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'VERTICALS');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('VerticalsMaster')));
$str = "<script>
