...
function additionalDetailsVerticals($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'VerticalsMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=VerticalsMaster&return_module=VerticalsMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=VerticalsMaster&return_module=VerticalsMaster&record={$fields['ID']}");
}
