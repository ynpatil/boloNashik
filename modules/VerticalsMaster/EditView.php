...
require_once('modules/VerticalsMaster/Forms.php');
...
$GLOBALS['log']->info("Verticals Master detail view");

$xtpl=new XTemplate ('modules/VerticalsMaster/EditView.html');
