...
$xtpl->assign('encoded_aor_popup_request_data', $json->encode($popup_request_data));
...
$xtpl->assign('encoded_industry_popup_request_data', $json->encode($popup_request_data));
...
$xtpl->assign('encoded_linkage_popup_request_data', $json->encode($popup_request_data));
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		...
		'state_id_c' => 'billing_address_state',
		'state_id_c_name' => 'billing_address_state_desc',		
		'country_id_c' => 'billing_address_country',
		'country_id_c_name' => 'billing_address_country_desc',
		),	
	);

$xtpl->assign('encoded_billing_city_popup_request_data', $json->encode($popup_request_data));
...
$xtpl->assign('encoded_billing_state_popup_request_data', $json->encode($popup_request_data));
...
$xtpl->assign('encoded_billing_country_popup_request_data', $json->encode($popup_request_data));
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		...
		'name' => 'shipping_address_city_desc',
		'state_id_c' => 'shipping_address_state',
		'state_id_c_name' => 'shipping_address_state_desc',		
		'country_id_c' => 'shipping_address_country',
		'country_id_c_name' => 'shipping_address_country_desc',		
		),	
	);

$xtpl->assign('encoded_shipping_city_popup_request_data', $json->encode($popup_request_data));
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		...
		'name' => 'shipping_address_state_desc',
		'country_id_c' => 'shipping_address_country',
		'country_id_c_name' => 'shipping_address_country_desc',
		),	
	);

$xtpl->assign('encoded_shipping_state_popup_request_data', $json->encode($popup_request_data));
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		...
		'name' => 'shipping_address_country_desc',
		),	
	);

$xtpl->assign('encoded_shipping_country_popup_request_data', $json->encode($popup_request_data));
...
if(isset($_REQUEST['source_info_id'])) $xtpl->assign("SOURCE_INFO_ID", $_REQUEST['source_info_id']);
...
$sqs_objects = array('parent_name' => $qsd->getQSParent(),
					...
					'industry_name' => $qsd->getQSIndustry(),	
					'linkage_desc_c' => $qsd->getQSLinkage(),				
					);
...
$xtpl->assign("BILLING_ADDRESS_CITY_DESC", $focus->billing_address_city_desc);
$xtpl->assign("BILLING_ADDRESS_STATE", $focus->billing_address_state);
$xtpl->assign("BILLING_ADDRESS_STATE_DESC", $focus->billing_address_state_desc);
...
$xtpl->assign("BILLING_ADDRESS_COUNTRY_DESC", $focus->billing_address_country_desc);
...
$xtpl->assign("ANNIVERSARY", $focus->anniversary);
$xtpl->assign("INDUSTRY", $focus->industry);
$xtpl->assign("INDUSTRY_NAME", $focus->industry_name);
$xtpl->assign("LINKAGE_ID", $focus->linkage_id);
...
$xtpl->assign("SHIPPING_ADDRESS_CITY_DESC", $focus->shipping_address_city_desc);
$xtpl->assign("SHIPPING_ADDRESS_STATE", $focus->shipping_address_state);
$xtpl->assign("SHIPPING_ADDRESS_STATE_DESC", $focus->shipping_address_state_desc);
$xtpl->assign("SHIPPING_ADDRESS_COUNTRY", $focus->shipping_address_country);
$xtpl->assign("SHIPPING_ADDRESS_COUNTRY_DESC", $focus->shipping_address_country_desc);
...
$xtpl->assign("AOR_SEARCH", "&account_type=Client");//to show only Agencies of type Client
...
$xtpl->assign("OWNERSHIP_OPTIONS", get_select_options_with_id($app_list_strings['account_ownership_dom'], $focus->ownership));
