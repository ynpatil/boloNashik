...
function selectDocumentType(select_options)
{
	var selectedOption = select_options.options[select_options.selectedIndex].value;
	
	var divObj = document.getElementById("doc_type_id");
	if(!divObj)return;
