...
function additionalDetailsOfficetype($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'OfficetypeMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=OfficetypeMaster&return_module=OfficetypeMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=OfficetypeMaster&return_module=OfficetypeMaster&record={$fields['ID']}");
}
