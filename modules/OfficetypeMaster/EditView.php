...
require_once('modules/OfficetypeMaster/Forms.php');
...
$GLOBALS['log']->info("Officetype Master detail view");

$xtpl=new XTemplate ('modules/OfficetypeMaster/EditView.html');
