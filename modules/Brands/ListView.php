...
if(file_exists('custom/modules/Brands/metadata/listviewdefs.php')){
	require_once('custom/modules/Brands/metadata/listviewdefs.php');
}else{
	require_once('modules/Brands/metadata/listviewdefs.php');
}
...
$seedBrand = new Brand();
$searchForm = new SearchForm('Brands', $seedBrand);
...
if(!empty($_REQUEST['displayColumns'])) {
    foreach(explode('|', $_REQUEST['displayColumns']) as $num => $col) {
        if(!empty($listViewDefs['Brands'][$col]))
            $displayColumns[$col] = $listViewDefs['Brands'][$col];
    }
}
elseif(!empty($savedDisplayColumns)) {
    ...
    foreach($listViewDefs['Brands'] as $col => $params) {
...
if(isset($_REQUEST['query']))
{
    ...
    $where_clauses = $searchForm->generateSearchWhere(true, "Brands");
...
$lv->setup($seedBrand, 'include/ListView/ListViewGeneric.tpl', $where, $params);
