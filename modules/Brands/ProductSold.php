...
echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME'], "Import : ".$mod_strings['LBL_MODULE_NAME']." ".$mod_strings['LBL_SOLD_NAME'], true);
echo "\n</p>\n";
global $theme;
...
$xtpl=new XTemplate ('modules/Brands/ProductSold.html');
...
if (($_REQUEST['msg'])) {
	$xtpl->assign("FILE_MSG", $_REQUEST['msg']);
}
if (!empty($campaign)) {
