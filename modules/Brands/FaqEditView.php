...
echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME'], $mod_strings['LBL_MODULE_NAME'] . ": FAQ: " . $focus->name, true);
echo "\n</p>\n";
global $theme;
...
$xtpl = new XTemplate('modules/Brands/FaqEditView.html');
...
$xtpl->assign("BRAND_ID", $_REQUEST['record']);


$xtpl->assign("FAQ", ($focus->faq));
...
if (isset($_REQUEST['parent_name']))
    $xtpl->assign("PARENT_NAME", urldecode($_REQUEST['parent_name']));
