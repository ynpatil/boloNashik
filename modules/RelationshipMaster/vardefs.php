 ...
 ********************************************************************************/
$dictionary['RelationshipMaster'] = array('table' => 'relationship_mast',
'audited'=>true, 'unified_search' => true, 'duplicate_merge'=>true,
  'comment' => 'Master to maintain RelationshipMaster records',
                               'fields' => array (
  ...
  array (
    ...
    'duplicate_merge'=>'disabled'
       ...
       array('name' =>'idx_relationship_name', 'type'=>'index', 'fields'=>array('name','deleted')),
)
                            );
?>
