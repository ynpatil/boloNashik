...
function additionalDetailsRelationshipMaster($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'RelationshipMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=RelationshipMaster&return_module=RelationshipMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=RelationshipMaster&return_module=RelationshipMaster&record={$fields['ID']}");
}
