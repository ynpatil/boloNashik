 ...
 */
 ...
 // $Id: RelationshipHandler.php,v 1.6 2006/08/22 19:47:31 awu Exp $



require_once('data/SugarBean.php');
require_once('include/utils.php');
include_once('modules/Relationships/Relationship.php');
...
function get_relationship_information(& $target_bean){
