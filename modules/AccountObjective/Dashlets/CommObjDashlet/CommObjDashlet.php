...
class CommObjDashlet extends AccountObjectiveDashlet {
     ...
     */
    function CommObjDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('CommObjDashlet','modules/AccountObjective/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountObjective/Dashlets/CommObjDashlet/CommObjDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountObjective/Dashlets/CommObjDashlet/CommObjDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountObjective/Dashlets/CommObjDashlet/CommObjDashletOptions.tpl');
    }
}
