 ...
 ********************************************************************************/
//om
require_once('include/Dashlets/AccountObjectiveDashlet.php');
require_once('include/Sugar_Smarty.php');

require_once('modules/AccountObjective/AccountObjective.php');

class LatestHappenDashlet extends AccountObjectiveDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'latest_happen';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function LatestHappenDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('LatestHappenDashlet','modules/AccountObjective/Dashlets/'); // load the language strings here
        ...
        parent::AccountObjectiveDashlet($id,$parent_type); // call parent constructor
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountObjective/Dashlets/LatestHappenDashlet/LatestHappenDashlet.tpl');
    ...
    function displayScript() {
		...
		$ss->assign('parent_type', $this->parent_type);
		$GLOBALS['log']->debug("Is owner :".$this->owner);

        $str = $ss->fetch('modules/AccountObjective/Dashlets/LatestHappenDashlet/LatestHappenDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountObjective/Dashlets/LatestHappenDashlet/LatestHappenDashletOptions.tpl');
    }
