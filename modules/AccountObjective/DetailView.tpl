...
<script type="text/javascript" src='modules/AccountObjective/accountobjective.js?s={$sugarVersion}&c={$jsCustomVersion}'></script>
...
<table cellspacing='5' cellpadding='0' border='0' valign='top' width='100%'>
	...
	<td align='left' colspan='2'>
		...
		<tr>
			<td valign='top'>
				<IMG src='themes/Sugar/images/{$parent_type}.gif' width='15' height='16' border='0' style='margin-top: 3px; margin-right: 0px;' alt='{$parent_type}'>
		        </td>
		        <td valign='top' align='left' width="95">
		        <h2>{$main_module}</h2>
		        </td>	
   		        <td valign='top' align='left'>
   		         for {$parent_desc} - {$parent_type}
   		        </td>
		</tr>
