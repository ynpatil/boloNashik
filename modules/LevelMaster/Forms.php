...
function get_new_record_form()
{
	return '';
/*
	if(!ACLController::checkAccess('LevelMaster', 'edit', true))return '';
	global $app_strings;
	global $mod_strings;
	global $currentModule;
	global $current_user;

	$the_form = get_left_form_header($mod_strings['LBL_QUICK_NEW_LEVEL']);
	$form = new XTemplate ('modules/LevelMaster/Forms.html');
	...
	$form->assign('encoded_level_popup_request_data', $json->encode($popup_request_data));
