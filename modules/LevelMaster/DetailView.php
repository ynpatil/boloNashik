...
$GLOBALS['log']->info('Level detail view');
$focus = new Level();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("LEVEL", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/LevelMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "LEVEL", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'LEVEL');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('LevelMaster')));
$str = "<script>
