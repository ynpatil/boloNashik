...
require_once('modules/LevelMaster/Forms.php');
...
$GLOBALS['log']->info("Level Master detail view");

$xtpl=new XTemplate ('modules/LevelMaster/EditView.html');
