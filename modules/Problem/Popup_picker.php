...
class Popup_Picker{
	...
	function _get_where_clause(){
		...
		{
			$where_clauses = array();
			append_where_clause($where_clauses, "name", "problem.name");
	...
	function process_page(){
		...
		$form = new XTemplate('modules/Problem/Popup_picker.html');
		...
		ob_start();
		$ListView->processListView($seed_bean, 'main', 'PROBLEM');
		$output_html .= ob_get_contents();
		ob_end_clean();
