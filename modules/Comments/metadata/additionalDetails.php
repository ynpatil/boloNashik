...
function additionalDetailsComment($fields) {
	static $mod_strings;
	...
	$editLink = "index.php?action=EditView&module=Comments&record={$fields['ID']}";
	$viewLink = "index.php?action=DetailView&module=Comments&record={$fields['ID']}";

	$return_module = empty($_REQUEST['module']) ? 'Comments' : $_REQUEST['module'];
