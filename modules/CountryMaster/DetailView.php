...
/**
 * The detailed view for a Country
 *
...
$GLOBALS['log']->info('Country detail view');
$focus = new Country();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("COUNTRY", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/CountryMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "COUNTRY", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'COUNTRY');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('CountryMaster')));
$str = "<script>
