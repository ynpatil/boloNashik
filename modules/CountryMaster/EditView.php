...
require_once('modules/CountryMaster/Forms.php');
...
$GLOBALS['log']->info("Country Master detail view");

$xtpl=new XTemplate ('modules/CountryMaster/EditView.html');
