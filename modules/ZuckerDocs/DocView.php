...
$dmsLog->debug("#$# *********** Inside DocView.php Test Log in sugarcrm.log ***********"); 
$dmsLog->info("#$# *********** Inside DocView.php Test Log in sugarcrm.log ***********"); 
$dmsLog->fatal("#$# *********** Inside DocView.php Test Log in sugarcrm.log ***********"); 
$dmsLog->warn("#$# *********** Inside DocView.php Test Log in sugarcrm.log ***********");
$dmsLog->error("#$# *********** Inside DocView.php Test Log in sugarcrm.log ***********"); 
...
$logger = &LoggerManager::getLogger('dms');
$logger->debug("SRIRAM");
// #$# End
...
if ($focus->errorMessage) {
	...
	$xtpl=new XTemplate ('modules/ZuckerDocs/DocView.html');
	...
	/**	#$# MOD-MAY 12 
	$xtpl->assign("CATNAME", $app_list_strings['doc_category'][$focus->cat_name]);
	*/
	
	$xtpl->assign("CATNAME", $focus->cat_name);
	...
	if (!empty($_REQUEST['DMS_MANAGE_ERROR'])) {
	...
	if (!empty($_REQUEST['DMS_MANAGE_SCRIPT'])) {
	...
	$histView->initNewXTemplate('modules/ZuckerDocs/DocView.html', $mod_strings);
	...
	$button .= "<input type='hidden' name='return_action' value='DocView'>\n";
