...
function additionalDetailsRegion($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'RegionMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=RegionMaster&return_module=RegionMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=RegionMaster&return_module=RegionMaster&record={$fields['ID']}");
}
