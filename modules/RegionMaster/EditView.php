...
require_once('modules/RegionMaster/Forms.php');
...
$GLOBALS['log']->info("Region Master detail view");

$xtpl=new XTemplate ('modules/RegionMaster/EditView.html');
