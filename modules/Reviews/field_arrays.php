 ...
 * Contributor(s): ______________________________________..
 ********************************************************************************/
$fields_array['Review'] = array ('column_fields' =>Array("id"
		, "date_entered"
		, "date_modified"
		, "assigned_user_id"
		, "modified_user_id"
    ...
    'list_fields' =>  Array('id', 'status', 'name', 'parent_type', 'parent_name', 'parent_id', 'assigned_user_name', 'assigned_user_id'),
