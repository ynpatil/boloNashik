...
if(ACLController::checkAccess('Activities', 'list', true))$module_menu[]=Array("index.php?module=Reviews&action=index&return_module=Reviews&return_action=DetailView", $mod_strings['LNK_REVIEW_LIST'],"Reviews");
