...
function get_new_record_form () {
	if(!ACLController::checkAccess('Reviews', 'edit', true)){
		return '';
	}
...
$the_form .= <<<EOQ
		<form name="ReviewSave" onSubmit="return check_form('ReviewSave')" method="POST" action="index.php">
...
$javascript->setFormName('ReviewSave');
$javascript->setSugarBean(new Review());
