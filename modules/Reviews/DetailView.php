...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("REVIEW", $focus, $offset);
	if($result == null) {
...
$xtpl=new XTemplate ('modules/Reviews/DetailView.html');
...
$detailView->processListNavigation($xtpl, "REVIEW", $offset);
...
$xtpl->assign("STATUS", $app_list_strings['review_status_dom'][$focus->status]);
/*
if ($app_list_strings['review_status_dom'][$focus->status] != "Completed")
{
    $close_and_create_button = '<input title="'.$app_strings['LBL_CLOSE_AND_CREATE_BUTTON_TITLE'].'" ' .
            ...
            'onclick="this.form.status.value=\'Completed\';this.form.action.value=\'Save\';this.form.return_module.value=\'Reviews\';' .
