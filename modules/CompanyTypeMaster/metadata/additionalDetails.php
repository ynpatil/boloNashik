...
function additionalDetailsCompanyType($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'CompanyTypeMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=CompanyTypeMaster&return_module=CompanyTypeMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=CompanyTypeMaster&return_module=CompanyTypeMaster&record={$fields['ID']}");
}
