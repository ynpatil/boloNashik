...
function additionalDetailsIndustry($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'IndustryMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=IndustryMaster&return_module=IndustryMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=IndustryMaster&return_module=IndustryMaster&record={$fields['ID']}");
}
