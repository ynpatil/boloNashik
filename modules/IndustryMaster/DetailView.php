...
/**
 * The detailed view for a Industry
 *
...
$GLOBALS['log']->info('Industry detail view');
$focus = new Industry();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("INDUSTRY", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/IndustryMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "INDUSTRY", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'INDUSTRY');
