...
/**
 * The detailed view for a Function
 *
...
$GLOBALS['log']->info('Function detail view');
$focus = new FunctionMaster();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("FUNCTION", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/FunctionMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "FUNCTION", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'FUNCTION');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('FunctionMaster')));
$str = "<script>
