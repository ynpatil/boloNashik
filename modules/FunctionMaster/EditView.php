...
require_once('modules/FunctionMaster/Forms.php');
...
$GLOBALS['log']->info("Function Master detail view");

$xtpl=new XTemplate ('modules/FunctionMaster/EditView.html');
