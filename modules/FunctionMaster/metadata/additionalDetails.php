...
function additionalDetailsFunctionMaster($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'FunctionMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=FunctionMaster&return_module=FunctionMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=FunctionMaster&return_module=FunctionMaster&record={$fields['ID']}");
}
