...
$xtpl->assign('SUBOFFICE_ID',$focus->suboffice_id);
$xtpl->assign('SUBOFFICE_NAME',$focus->suboffice_name);

$xtpl->assign('USERTYPE_ID',$focus->usertype_id);
$xtpl->assign('USERTYPE_NAME',$focus->usertype_name);

$xtpl->assign('VERTICALS_ID',$focus->verticals_id);
...
if(!$current_user->is_superuser)
	$xtpl->assign('IS_SUPERUSER_DISABLED', 'disabled="disabled"');	
...
else
{
	...
	$json = getJSONobj();
	$encoded_popup_request_data = $json->encode($popup_request_data);
	$xtpl->assign('encoded_suboffice_popup_request_data', $encoded_popup_request_data);
	...
	$encoded_popup_request_data = $json->encode($popup_request_data);
	$xtpl->assign('encoded_usertype_popup_request_data', $encoded_popup_request_data);
	...
	$encoded_popup_request_data = $json->encode($popup_request_data);
	$xtpl->assign('encoded_verticals_popup_request_data', $encoded_popup_request_data);
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		'id' => 'address_city',
		'name' => 'address_city_desc',
		'state_id_c' => 'address_state',
		'state_id_c_name' => 'address_state_desc',		
		'country_id_c' => 'address_country',
		'country_id_c_name' => 'address_country_desc',
		),	
	);

$xtpl->assign('encoded_city_popup_request_data', $json->encode($popup_request_data));
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		'id' => 'address_state',
		'name' => 'address_state_desc',
		'country_id_c' => 'address_country',
		'country_id_c_name' => 'address_country_desc',
		),	
	);

$xtpl->assign('encoded_state_popup_request_data', $json->encode($popup_request_data));
...
$popup_request_data = array(
	...
	'field_to_name_array' => array(
		'id' => 'address_country',
		'name' => 'address_country_desc',
		),	
	);

$xtpl->assign('encoded_country_popup_request_data', $json->encode($popup_request_data));
...
// Override Default tabs array 
if(!$focus->id){
    $chooser->args['values_array'][0]=$app_list_strings['default_display_tabs'];
    $chooser->args['values_array'][1]=$app_list_strings['default_hide_tabs'];
}
...
///echo "<pre>";print_r($chooser->args['values_array']);
