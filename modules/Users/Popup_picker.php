...
EOQ;
		...
		$options_array = get_bean_select_array(true, 'Suboffice', 'name', 'deleted=0', 'name',false);
		$form->assign("SUBOFFICES_OPTIONS", get_select_options_with_id($options_array,$_REQUEST['suboffice_id']));
		$options_array = get_bean_select_array(true, 'UserType', 'name', 'deleted=0', 'name',false);
		$form->assign("USERTYPES_OPTIONS", get_select_options_with_id($options_array,$_REQUEST['usertype_id']));
		$options_array = get_bean_select_array(true, 'Verticals', 'name', 'deleted=0', 'name',false);
		$form->assign("VERTICALS_OPTIONS", get_select_options_with_id($options_array,$_REQUEST['verticals_id']));
