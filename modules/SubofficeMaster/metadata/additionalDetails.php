...
function additionalDetailsSuboffice($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'SubofficeMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=SubofficeMaster&return_module=SubofficeMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=SubofficeMaster&return_module=SubofficeMaster&record={$fields['ID']}");
}
