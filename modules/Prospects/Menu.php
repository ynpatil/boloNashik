 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Menu.php,v 1.12 2006/07/20 16:55:16 jenny Exp $
...
if(ACLController::checkAccess('Prospects', 'import', true))$module_menu[]=	Array("index.php?module=Prospects&action=Import&step=1&return_module=Prospects&return_action=index", $app_strings['LBL_IMPORT'],"Import");
if(ACLController::checkAccess('Prospects','list', true)) $module_menu[] = Array('#', '<span style="display: none">wp_shortcut_fill_0</span>', '');
