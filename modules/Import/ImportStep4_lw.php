...
log_into_file($ImportErrorFile, $first_line_str);
...
foreach ($rows as $row) {
    ...
    if ($_REQUEST['module'] == "Leads") {
        echo $import_city = $focus->primary_address_city;
...
//        if (strstr($this->phone_other,'E+') ){
//             $badline = implode(",", $row);
//            $not_imported_str = $badline . ",Alternet phone number format is not correct \n";
//            log_into_file($ImportErrorFile, $not_imported_str);
//            continue;
//        }
    }
