...
$GLOBALS['log']->info('City detail view');
$focus = new City();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("CITY", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/CityMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "CITY", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'CITY');
