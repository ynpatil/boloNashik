...
require_once('modules/CityMaster/Forms.php');
...
$GLOBALS['log']->info("City Master detail view");

$xtpl=new XTemplate ('modules/CityMaster/EditView.html');
...
$sqs_objects = array('assigned_user_name' => $qsd->getQSUser(),'state_id_c_name' => $qsd->getQSState());
...
$xtpl->assign("NAME", $focus->name);
$xtpl->assign("state_id_c", $focus->state_id_c);
...
//$javascript->addToValidateBinaryDependency('state_id_c_name', 'alpha', $app_strings['ERR_SQS_NO_MATCH_FIELD'] . $app_strings['LBL_STATE_NAME'], 'false', '', 'state_id_c');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('CityMaster')));
$str = "<script>
