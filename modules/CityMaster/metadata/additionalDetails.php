...
function additionalDetailsCity($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'CityMaster');
	}
	...
	if(!empty($fields['STATE_ID_C_NAME'])) {
		$overlib_string .= '<b>'. $mod_strings['LBL_STATE_NAME'] . '</b> ' .$fields['STATE_ID_C_NAME']."<br/>";
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=CityMaster&return_module=CityMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=CityMaster&return_module=CityMaster&record={$fields['ID']}");
}
