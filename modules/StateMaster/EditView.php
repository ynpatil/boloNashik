...
require_once('modules/StateMaster/Forms.php');
...
$GLOBALS['log']->info("State Master detail view");

$xtpl=new XTemplate ('modules/StateMaster/EditView.html');
...
$encoded_popup_request_data = $json->encode($popup_request_data);
$xtpl->assign('encoded_region_popup_request_data', $encoded_popup_request_data);
...
$sqs_objects = array('assigned_user_name' => $qsd->getQSUser(),'country_id_c_name' => $qsd->getQSCountry());
$quicksearch_js = $qsd->getQSScripts();
//$quicksearch_js .= '<script type="text/javascript" language="javascript">sqs_objects = ' . $json->encode($sqs_objects) . '</script>';

$sqs_objects = array('assigned_user_name' => $qsd->getQSUser(),'region_id_c_name' => $qsd->getQSRegion());
$quicksearch_js .= $qsd->getQSScripts();
$quicksearch_js .= '<script type="text/javascript" language="javascript">sqs_objects = ' . $json->encode($sqs_objects) . '</script>';
...
$xtpl->assign("REGION_NAME", $focus->region_id_c_name);
...
//$javascript->addToValidateBinaryDependency('country_id_c_name', 'alpha', $app_strings['ERR_SQS_NO_MATCH_FIELD'] . $app_strings['LBL_COUNTRY_NAME'], 'false', '', 'country_id_c');
