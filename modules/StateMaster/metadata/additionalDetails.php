...
function additionalDetailsState($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'StateMaster');
	}
	...
	if(!empty($fields['COUNTRY_ID_C_NAME'])) {
		$overlib_string .= '<b>'. $mod_strings['LBL_COUNTRY_NAME'] . '</b> ' .$fields['COUNTRY_ID_C_NAME']."<br/>";
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=StateMaster&return_module=StateMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=StateMaster&return_module=StateMaster&record={$fields['ID']}");
}
