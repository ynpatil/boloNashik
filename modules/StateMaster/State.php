...
/**
 * Data access layer for the state_mast table
 *
 ...
 */
//om
// $Id: StateMaster.php,v 1.58 2006/06/29 18:30:47 eddy Exp $
...
class State extends SugarBean {
    ...
    var $created_by_name;
    var $region_id_c;
    var $region_id_c_name;
    var $object_name = 'State';
    var $module_dir = 'StateMaster';
    var $new_schema = true;
    var $table_name = 'state_mast';
    ...
    function create_list_query($order_by, $where, $show_deleted = 0) {
        ...
        $query = "SELECT users.user_name assigned_user_name,state_mast.*";

        if ($custom_join) {
            $query .= $custom_join['select'];
        }
        $query .= " FROM state_mast ";

        $query .= "LEFT JOIN users ON state_mast.assigned_user_id=users.id ";
    ...
    function fill_in_additional_detail_fields() {
        ...
        $region_id_name = get_region_details($this->region_id_c);
        $this->region_id_c_name = $region_id_name['region_description'];
    }
    ...
    function build_generic_where_clause($the_query_string) {
        ...
        array_push($where_clauses, "state_mast.name LIKE '%$the_query_string%'");
    ...
    function get_list_view_data() {
        ...
        $additionalDetails = get_country_details($field_list['COUNTRY_ID_C']);
        ...
        //Added region id
        $additionalDetails = get_region_details($field_list['REGION_ID_C']);
        $field_list["REGION_ID_C"] = preg_replace("/[\r]/", '', $additionalDetails['region_id']);
        $field_list["REGION_ID_C_NAME"] = preg_replace("/[\r]/", '', $additionalDetails['region_description']);
