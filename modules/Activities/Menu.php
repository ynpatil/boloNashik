 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Menu.php,v 1.11 2006/06/06 17:57:54 majed Exp $
 * Description:
...
if(is_admin($current_user) || is_supersenior($current_user)){
    ...
    if(ACLController::checkAccess('Notes', 'import', true))$module_menu[]=Array("index.php?module=Notes&action=Import&step=1&return_module=Notes&return_action=index", $mod_strings['LNK_IMPORT_NOTES'],"Import");
