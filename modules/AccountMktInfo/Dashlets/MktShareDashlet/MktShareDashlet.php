...
class MktShareDashlet extends AccountMktInfoDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'mkt_share';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function MktShareDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('MktShareDashlet','modules/AccountMktInfo/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/MktShareDashlet/MktShareDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/MktShareDashlet/MktShareDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountMktInfo/Dashlets/MktShareDashlet/MktShareDashletOptions.tpl');
    }
}
