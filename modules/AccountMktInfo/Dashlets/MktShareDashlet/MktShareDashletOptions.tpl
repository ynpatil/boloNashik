...
<form name='configure_{$id}' action="index.php" method="post" onSubmit='return SUGAR.dashlets.postFormWithMethodParams("configure_{$id}", SUGAR.accountObjective.uncoverPage);'>
<input type='hidden' name='id' value='{$id}'>
<input type='hidden' name='record' value='{$record}'>
<input type='hidden' name='module' value='AccountMktInfo'>
