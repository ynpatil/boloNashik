...
class IndustryInfoDashlet extends AccountMktInfoDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'industry_info';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function IndustryInfoDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('IndustryInfoDashlet','modules/AccountMktInfo/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/IndustryInfoDashlet/IndustryInfoDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/IndustryInfoDashlet/IndustryInfoDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountMktInfo/Dashlets/IndustryInfoDashlet/IndustryInfoDashletOptions.tpl');
    }
}
