 ...
 ********************************************************************************/
//om
require_once('include/Dashlets/AccountMktInfoDashlet.php');
require_once('include/Sugar_Smarty.php');

require_once('modules/AccountMktInfo/AccountMktInfo.php');

class AnnualBusinessInfoDashlet extends AccountMktInfoDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'annual_info';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function AnnualBusinessInfoDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('AnnualBusinessInfoDashlet','modules/AccountMktInfo/Dashlets/'); // load the language strings here
        ...
        parent::AccountMktInfoDashlet($id,$parent_type); // call parent constructor
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/AnnualBusinessInfoDashlet/AnnualBusinessInfoDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/AnnualBusinessInfoDashlet/AnnualBusinessInfoDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountMktInfo/Dashlets/AnnualBusinessInfoDashlet/AnnualBusinessInfoDashletOptions.tpl');
    }
}
