...
class SeasonInfoDashlet extends AccountMktInfoDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'season_info';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function SeasonInfoDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('SeasonInfoDashlet','modules/AccountMktInfo/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/SeasonInfoDashlet/SeasonInfoDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/SeasonInfoDashlet/SeasonInfoDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountMktInfo/Dashlets/SeasonInfoDashlet/SeasonInfoDashletOptions.tpl');
    }
}
