...
class CompInfoDashlet extends AccountMktInfoDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'comp_info';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function CompInfoDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('CompInfoDashlet','modules/AccountMktInfo/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/CompInfoDashlet/CompInfoDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountMktInfo/Dashlets/CompInfoDashlet/CompInfoDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountMktInfo/Dashlets/CompInfoDashlet/CompInfoDashletOptions.tpl');
    }
}
