...
/**
 * Data access layer for the account_mkt_info table
 *
 ...
 */
//om
// $Id: AccountMktInfo.php,v 1.58 2006/06/29 18:30:47 eddy Exp $
 ...
 *
 */
class AccountMktInfo extends SugarBean {
	...
	var $object_name = 'AccountMktInfo';
	var $module_dir = 'AccountMktInfo';
	var $new_schema = false;
	var $table_name = 'account_mkt_info';
...
//			echo "Bean file :".$beanFiles[$beanClass]." class ".$beanClass;
	...
	function save($check_notify = FALSE)//allows for part data save from AccountMktInfoDashlet
	{
		global $timedate;
