 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: ListView.php,v 1.78 2006/08/04 01:04:54 wayne Exp $
...
if(file_exists('custom/modules/Cases/metadata/listviewdefs.php')){
	require_once('custom/modules/Cases/metadata/listviewdefs.php');	
}else{
	require_once('modules/Cases/metadata/listviewdefs.php');
}
