...
require_once('modules/DIOMaster/Forms.php');
...
$GLOBALS['log']->info("DIO Master detail view");

$xtpl=new XTemplate ('modules/DIOMaster/EditView.html');
