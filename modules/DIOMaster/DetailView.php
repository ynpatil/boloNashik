...
$GLOBALS['log']->info('DIO detail view');
$focus = new DIO();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("DIO", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/DIOMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "DIO", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'DIO');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('DIOMaster')));
$str = "<script>
