...
function additionalDetailsDIO($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'DIOMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=DIOMaster&return_module=DIOMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=DIOMaster&return_module=DIOMaster&record={$fields['ID']}");
}
