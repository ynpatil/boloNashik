...
{
	require_once("modules/ActivityReport/MeetingListViewQueryMovement.php");
...
{
	require_once("modules/ActivityReport/CallListViewQueryMovement.php");
...
{
	require_once("modules/ActivityReport/TaskListViewQueryMovement.php");
...
//	echo "User :".$user_trimmed[1];
	...
	$search_form=new XTemplate ('modules/ActivityReport/SearchFormMovement.html');
...
$xtpl=new XTemplate ('modules/ActivityReport/OpenListViewMovement.html');
...
$xtpl->assign("REPORT_TYPE","Movement Register");
...
global $from_date,$to_date,$total_meeting_field_minutes;
...
$xtpl->assign("TOTAL_FIELD_TIME", $total_meeting_field_minutes);
$xtpl->assign("AVERAGE_FIELD_TIME",round($total_meeting_field_minutes/$no_of_working_days,2));
