...
require_once("modules/Meetings/MeetingRequestListViewQuery.php");
require_once("modules/Meetings/MeetingRequestListViewDisplay.php");

if(count($account_list)>0)
{
echo "\n<p>\n";

$xtpl=new XTemplate ('modules/Meetings/SubPanelMeetingRequestView.html');
...
foreach($account_list as $account)
{
 ...
 $xtpl->assign("MEETING", $activity_fields);
