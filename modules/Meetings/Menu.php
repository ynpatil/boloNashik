 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Menu.php,v 1.35 2006/07/13 22:28:25 jenny Exp $
...
if(ACLController::checkAccess('Meetings', 'list', true))$module_menu[]=Array("index.php?module=Meetings&action=RequestsListView&return_module=Meetings&return_action=DetailView", $mod_strings['LNK_MEETING_REQUESTS'],"Meetings", 'Meetings');
