 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: en_us.lang.php,v 1.28 2006/08/22 20:13:17 chris Exp $
 * Description:
...
$mod_strings = array(
	...
	'ERR_UW_NO_FILE_UPLOADED'					=> 'Please specify a file and try again!<br>\n',
	'ERR_UW_NO_FILES'							=> 'An error occured, no files were found to check.',
	...
	'LBL_UW_CANCEL_DESC'						=> 'Upgrade Wizard has been cancelled.  All temporary files and the uploaded zip file have been deleted.<br><br>Press "Next" to restart the Upgrade Wizard.',
	...
	'LBL_UW_START_DESC'							=> 'Welcome to the SugarCRM Upgrade Wizard. This wizard is designed to assist adminstrators when upgrading their SugarCRM instances.  Please follow the given instructions carefully.',
	'LBL_UW_START_DESC2'						=> 'We highly recommend the upgrade be performed against a cloned instance of your production server.  Please backup your database and your system files (all files in your SugarCRM folder) before performing this operation - prevention is always better than cure.', 
