...
function additionalDetailsCompliance($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'ComplianceMaster');
	}
	...
	if(!empty($fields['BRANCH_ID_C_NAME'])) {
		$overlib_string .= '<b>'. $mod_strings['LBL_BRANCH_NAME'] . '</b> ' .$fields['BRANCH_ID_C_NAME']."<br/>";
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=ComplianceMaster&return_module=ComplianceMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=ComplianceMaster&return_module=ComplianceMaster&record={$fields['ID']}");
}
