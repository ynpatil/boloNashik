...
function get_new_record_form()
{
	return '';
/*
	if(!ACLController::checkAccess('UserTypeMaster', 'edit', true))return '';
	global $app_strings;
	global $mod_strings;
	global $currentModule;
	global $current_user;

	$the_form = get_left_form_header($mod_strings['LBL_QUICK_NEW_USERTYPE']);
	$form = new XTemplate ('modules/UserTypeMaster/Forms.html');
	...
	$form->assign('encoded_usertype_popup_request_data', $json->encode($popup_request_data));
