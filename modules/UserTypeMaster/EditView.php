...
require_once('modules/UserTypeMaster/Forms.php');
...
$GLOBALS['log']->info("UserType Master detail view");

$xtpl=new XTemplate ('modules/UserTypeMaster/EditView.html');
