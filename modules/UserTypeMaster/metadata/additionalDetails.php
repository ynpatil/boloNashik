...
function additionalDetailsUserType($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'UserTypeMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=UserTypeMaster&return_module=UserTypeMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=UserTypeMaster&return_module=UserTypeMaster&record={$fields['ID']}");
}
