...
/**
 * The detailed view for a UserType
 *
...
$GLOBALS['log']->info('UserType detail view');
$focus = new UserType();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("USERTYPE", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/UserTypeMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "USERTYPE", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'USERTYPE');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('UserTypeMaster')));
$str = "<script>
