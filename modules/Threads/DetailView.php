...
$url = "index.php?module=Posts&action=EditView&return_module=Threads&return_action=DetailView&return_id=".$_REQUEST['record'];
    ...
    <tr>
        <td style="padding-bottom: 2px;">
            <form action="index.php" method="post" name="DetailView" id="form">
                ...
                <td style="padding-bottom: 2px;">
                <INPUT type="button" class="button" value="<?php echo $mod_strings['LBL_REPLY_TO_POST']; ?>" name="<? echo $_REQUEST['record']; ?>" onClick="window.location='<?php echo $url ?>'">
                </td>
            </form>
        </td>
    </tr>
