 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Step3.php,v 1.18 2006/08/29 22:21:31 ajay Exp $
...
$header_cols= array();
foreach ($merge_ids_array as $id) {
  $td="<td width='$col_width' valign='top' class='dataLabel' align='left'><a id='$id' onclick=\"change_primary(this,'{$id}');\" href='#' class='listViewPaginationLinkS1'>{$mod_strings['LBL_CHANGE_PARENT']}</a>";
