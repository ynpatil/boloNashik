...
require_once('modules/Contacts/Dashlets/BirthdaylistDashlet/ListViewDataBDL.php');
require_once('include/MassUpdate.php');

class ListViewDisplayBDL {
	 ...
	 * @return null
	 */
	function ListViewDisplayBDL() {
		$this->lvd = new ListViewDataBDL();
	}
