...
require_once("modules/Contacts/ContactRequestListViewQuery.php");
require_once("modules/Contacts/ContactRequestListViewDisplay.php");

if(count($account_list)>0)
{
echo "\n<p>\n";

$xtpl=new XTemplate ('modules/Contacts/SubPanelContactRequestView.html');
$current_module_strings = return_module_language($current_language, 'Contacts');
