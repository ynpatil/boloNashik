...
require_once("modules/Calls/CallRequestListViewQuery.php");
require_once("modules/Calls/CallRequestListViewDisplay.php");

if(count($account_list)>0)
{
echo "\n<p>\n";

$xtpl=new XTemplate ('modules/Calls/SubPanelCallRequestView.html');
...
foreach($account_list as $account)
{
 ...
 $xtpl->assign("CALL", $activity_fields);
