 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Menu.php,v 1.36 2006/07/13 22:28:00 jenny Exp $
 * Description:
...
//if(ACLController::checkAccess('Calls', 'list', true))$module_menu[]=Array("index.php?module=Calls&action=RequestsListView&return_module=Calls&return_action=DetailView", $mod_strings['LNK_CALL_REQUESTS'],"Calls", 'Calls');
