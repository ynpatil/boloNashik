...
/**
 * The detailed view for a Language
 *
...
$GLOBALS['log']->info('Language detail view');
$focus = new Language();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("LANGUAGE", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/LanguageMaster/DetailView.html');
...
$detailView->processListNavigation($xtpl, "LANGUAGE", $offset, $focus->is_AuditEnabled());
...
$subpanel = new SubPanelTiles($focus, 'LANGUAGE');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('LanguageMaster')));
$str = "<script>
