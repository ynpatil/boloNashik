...
require_once('modules/LanguageMaster/Forms.php');
...
$GLOBALS['log']->info("Language Master detail view");

$xtpl=new XTemplate ('modules/LanguageMaster/EditView.html');
