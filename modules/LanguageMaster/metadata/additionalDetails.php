...
function additionalDetailsLanguage($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'LanguageMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=LanguageMaster&return_module=LanguageMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=LanguageMaster&return_module=LanguageMaster&record={$fields['ID']}");
}
