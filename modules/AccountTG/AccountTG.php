...
/**
 * Data access layer for the account_tg table
 *
 ...
 */
//om
// $Id: AccountTG.php,v 1.58 2006/06/29 18:30:47 eddy Exp $
 ...
 *
 */
class AccountTG extends SugarBean {
	...
	var $object_name = 'AccountTG';
	var $module_dir = 'AccountTG';
	var $new_schema = false;
	var $table_name = 'account_tg';
...
//			echo "Bean file :".$beanFiles[$beanClass]." class ".$beanClass;
	...
	function save($check_notify = FALSE)//allows for part data save from AccountTGDashlet
	{
		global $timedate;
