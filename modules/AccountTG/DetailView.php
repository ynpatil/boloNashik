...
/**
 * The detailed view for a AccountTG
 *
...
$columns = $current_user->getPreference('columns', 'accounttg');
...
if(!isset($columns) || !isset($dashlets)) {
    ...
    $defaultDashlets = array('DemographicDashlet','PsychographicDashlet','MediaHabitsDashlet');
    ...
    $current_user->setPreference('dashlets', $dashlets, 0, 'accounttg');
    $current_user->setPreference('columns', $columns, 0, 'accounttg');
}
...
echo $sugar_smarty->fetch('modules/AccountTG/DetailView.tpl');
