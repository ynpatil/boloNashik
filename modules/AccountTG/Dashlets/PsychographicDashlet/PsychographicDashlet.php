...
class PsychographicDashlet extends AccountTGDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'psychographic';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function PsychographicDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('PsychographicDashlet','modules/AccountTG/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountTG/Dashlets/PsychographicDashlet/PsychographicDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountTG/Dashlets/PsychographicDashlet/PsychographicDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountTG/Dashlets/PsychograhicDashlet/PsychographicDashletOptions.tpl');
    }
}
