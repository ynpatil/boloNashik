...
class DemographicDashlet extends AccountTGDashlet {
    var $savedText; // users's saved text
    var $height = '100'; // height of the pad
	var $column = 'demographic';
	var $key;
	var $parent_type;
	var $parent_desc;
	var $owner;
     ...
     */
    function DemographicDashlet($id,$def,$key=NULL,$parent_type) {
        $this->loadLanguage('DemographicDashlet','modules/AccountTG/Dashlets/'); // load the language strings here
    ...
    function display() {
        ...
        $str = $ss->fetch('modules/AccountTG/Dashlets/DemographicDashlet/DemographicDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/AccountTG/Dashlets/DemographicDashlet/DemographicDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/AccountTG/Dashlets/DemograhicDashlet/DemographicDashletOptions.tpl');
    }
}
