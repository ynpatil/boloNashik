	    ...
	    return {
	        ...
	        blur: function(ta, id) {
	        	...
	        	// what data to post to the dashlet
    	    		...
    	    		postData = 'to_pdf=1&module=AccountTG&action=CallMethodDashlet&method=saveText&record={/literal}{$record}{literal}&return_module={/literal}{$parent_type}{literal}&id=' + id + '&savedText=' + ta.value;
