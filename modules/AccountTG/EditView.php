...
require_once('modules/AccountTG/Forms.php');
...
$GLOBALS['log']->info("AccountTG Master detail view");

$xtpl=new XTemplate ('modules/AccountTG/EditView.html');
...
$json = getJSONobj();
$savedSearchSelects = $json->encode(array($GLOBALS['app_strings']['LBL_SAVED_SEARCH_SHORTCUT'] . '<br>' . $savedSearch->getSelect('AccountTG')));
$str = "<script>
