...
require_once('modules/ExperienceMaster/Forms.php');
...
$GLOBALS['log']->info("Experience Master detail view");

$xtpl=new XTemplate ('modules/ExperienceMaster/EditView.html');
...
$xtpl->assign("NAME", $focus->name);
$xtpl->assign("EXP_MIN", $focus->exp_min);
$xtpl->assign("EXP_MAX", $focus->exp_max);
