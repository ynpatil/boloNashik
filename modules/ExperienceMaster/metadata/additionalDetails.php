...
function additionalDetailsExperience($fields) {
	static $mod_strings;
	if(empty($mod_strings)) {
		global $current_language;
		$mod_strings = return_module_language($current_language, 'ExperienceMaster');
	}
	...
	return array('fieldToAddTo' => 'NAME',
				 ...
				 'editLink' => "index.php?action=EditView&module=ExperienceMaster&return_module=ExperienceMaster&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=ExperienceMaster&return_module=ExperienceMaster&record={$fields['ID']}");
}
