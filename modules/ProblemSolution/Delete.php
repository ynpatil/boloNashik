...
/**
 * Delete functionality for a Solution
 *
...
// $Id: Delete.php,v 1.12.6.1 2006/01/08 04:36:05 majed Exp $

require_once('modules/ProblemSolution/ProblemSolution.php');
require_once('log4php/LoggerManager.php');


$sugarbean = new Solution();
...
$return_module = empty($_REQUEST['return_module']) ? 'Solution'
