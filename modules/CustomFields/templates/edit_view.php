...
function template_custom_fields_edit(&$bean)
{
...
<tr><td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                <th align="left" class="dataLabel" colspan="4"><h4 class="dataLabel">Custom Fields</h4></th>
                </tr>
<?php
...
?>
        <td width="15%" class="dataLabel"><?php echo $field['label']; ?>:</td>
        <td width="35%" class="dataField"><input type="text" name="<?php echo $field_name; ?>" value="<?php echo $bean->$field_name; ?>"\></td>
<?php
 if ($i % 2 == 1)
 {
?>
