 ...
 ********************************************************************************/
$dictionary['brands_contacts'] = array ( 'table' => 'brands_contacts'
                                  , 'fields' => array (
      ...
      , array('name' => 'idx_brand_contact', 'type'=>'alternate_key', 'fields'=>array('brand_id','contact_id'))
 	  ...
 	  , 'relationships' => array ('brands_contacts' => array('lhs_module'=> 'Brands', 'lhs_table'=> 'brands', 'lhs_key' => 'id',
							  'rhs_module'=> 'Contacts', 'rhs_table'=> 'contacts', 'rhs_key' => 'id',
							  'relationship_type'=>'many-to-many',
							  'join_table'=> 'brands_contacts', 'join_key_lhs'=>'brand_id', 'join_key_rhs'=>'contact_id'))
