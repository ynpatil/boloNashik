...
foreach($preListHeader as $module_name)
{
		...
		if ($i==$max_tabs-1 and $numb_tabs>$max_tabs) {
			$xtpl->assign("MORE", "<img src='".$image_path."more.gif' width='15' height='15' alt='More Tabs' align='absmiddle' id='MoreHandle' style='margin-bottom: 1px; margin-left:2px; cursor: hand;' align='absmiddle' onmouseover='tbButtonMouseOver(this.id,71,\"\",0);'>");
		} 
		$xtpl->parse("main.tab");
	$i++;
}
