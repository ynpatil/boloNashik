 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: layout_utils.php,v 1.15 2006/06/06 17:58:55 majed Exp $
...
$the_header = "";
       	$the_header .='<table cellpadding="0" cellspacing="0" border="0" width="100%">';
		$the_header .='<tr>';
		$the_header .='<th class="leftColumnModuleHead">'.$left_title.'</th></tr>';
		$the_header .='<tr><td align="left" class="leftColumnModuleS3">';
...
if($is_min_max === false){
	$the_form .= '<td nowrap><h3>&nbsp;<img src="'.$image_path.'h3Arrow.gif" border="0" alt="'.$form_title.'" align="top">&nbsp;'.$form_title.'</h3></td>';
} else {
