...
"altBg"=>"0x333333",
"altText"=>"0xdddddd",
"graphBorder"=>"0x00cccc",
"graphBg1"=>"0x000000",
"graphBg2"=>"0x000000",
"graphLines"=>"0x336666",
"graphText"=>"0xcccccc",
"graphTextShadow"=>"0x003333",
"barBorder"=>"0x999999",
"barBorderHilite"=>"0xFFFFFF",
"legendBorder"=>"0x666666",
"legendBg1"=>"0x333333",
"legendBg2"=>"0x333333",
"legendText"=>"0xdddddd",
"legendColorKeyBorder"=>"0x009999",
"scrollBar"=>"0x666666",
"scrollBarBorder"=>"0x666666",
"scrollBarTrack"=>"0x333333",
"scrollBarTrackBorder"=>"0x666666"
);
...
$the_header = "";
		...
		$the_header .='<tr>';
		$the_header .='<th width="9"><img src="'.$image_path.'moduleTab_left.gif" alt="" width="9" height="21" border="0" alt="$left_title"></th>';
		$the_header .='<th style="background-image : url('.$image_path.'moduleTab_middle.gif);" width="100%">'.$left_title.'</th>';
		$the_header .='<th width="9"><img src="'.$image_path.'moduleTab_right.gif" alt="" width="9" height="21" border="0" alt="'.$left_title.'"></th></tr>';
		$the_header .='</table>';
...
$the_form .= '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>';
 if ($is_min_max === false) {
 	$the_form .= '<td nowrap><h3><img src="'.$image_path.'h3Arrow.gif" width="10" height="17" border="0" alt="'.$form_title.'">&nbsp;'.$form_title.'</h3></td>';
 } else {
