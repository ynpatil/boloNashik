 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: footer.php,v 1.3 2006/06/06 17:58:55 majed Exp $
...
?>
<tr>
    <td colspan="3" align="center" style="background-image: url(<?php echo $image_path ?>moduleTitleBg.gif); background-repeat: repeat-x; background-position: top;">
	...
	if(isset($current_user)){
		...
		else echo "&nbsp;<img src='".$image_path."myAreaSeparator.gif' alt='|' align='absmiddle'>&nbsp;";
		if ($i == $max_tabs)
		echo "<br>";
		$i++;
} }?>
