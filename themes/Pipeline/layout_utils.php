...
$the_header .= '<tr class="moduleTab">';
$the_header .= '<td><img src="'.$image_path.'moduleTab_left.gif" width="6" height="6" border="0" alt="'.$left_title.'"></td>';
$the_header .= '<td width="100%" class="tabTableTop"><img src="include/images/blank.gif" width="1" height="1" alt=""></td>';
...
$html .= '<tr class="moduleTab">';
$html .= '<td><img src="'.$image_path.'moduleTab_lowerLeft.gif" width="6" height="6" border="0" alt=""></td>';
$html .= '<td width="100%" class="tabTableBottom"><img src="include/images/blank.gif" width="1" height="1" alt=""></td>';
