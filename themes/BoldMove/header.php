 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: header.php,v 1.10 2006/08/27 19:46:19 jbenterou Exp $
    ...
    foreach($groupedTabStructure as $mainTab => $subModules)
    {
        ...
        for($j = 0; $j < $end; $j++)
        {
            ...
            if($j == $end-1)
            {
                ...
                {
                	$xtpl->assign("SUB_MORE", "<li nowrap=\"nowrap\">&nbsp;<span class=\"subTabMore\" id=\\'MoreSub{$mainTab}Handle\\' style=\\' margin-left:2px; cursor: pointer; cursor: hand;\\' align=\\'absmiddle\\' onmouseover=\\'tbButtonMouseOver(this.id,\"\",\"\",-6,5);\\'><b>&gt;&gt;</b></span></li>");
                }
            }
