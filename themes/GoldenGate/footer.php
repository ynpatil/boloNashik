...
<tr>
	...
	else echo "<img src='".$image_path."myAreaSeparator.gif' alt='|' align='absmiddle' width='2' height='10' id='MoreHandle' style='margin-bottom: 0px; margin-left:5px; margin-right: 3px;' align='absmiddle'>";
		if ($i == $max_tabs)
		echo "<br>";
		$i++;
} }?>
